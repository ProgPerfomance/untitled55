...
class CheckinContinueDialog extends StatelessWidget {
  const CheckinContinueDialog({super.key});
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  child: SizedBox(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        floatingLabelBehavior: FloatingLabelBehavior.always,
                        label: Text("Pallets", style: GoogleFonts.dmSans(color: const Color(0x75FCFCFC), fontSize: 12, fontWeight: FontWeight.w500)),
                        hintStyle: GoogleFonts.dmSans(color: const Color(0x75FCFCFC), fontSize: 14, fontWeight: FontWeight.w400),
                        hintText: "Select",
                        suffixIcon: const Icon(Icons.keyboard_arrow_down, color: Color(0xFFD0D0D0)),
                      ),
            ...
            GestureDetector(
              onTap: controller.checkinConfirm,
              child: Container(
                height: 44,
